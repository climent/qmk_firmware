...
[_NAV] = LAYOUT( 
  ...
  KC_BSPC , C(KC_6), KC_HOME, KC_UP  , KC_END , KC_PGUP,                          XXXXXXX, KC_VOLD,      KC_MUTE, KC_VOLU,    KC_MPLY, XXXXXXX,
...
[_SYM] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, _______,  _______, XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX, _______,
                    KC_LOWER, XXXXXXX, KC_LALT, KC_LGUI, XXXXXXX,  MS_BTN1, MS_BTN2, XXXXXXX, XXXXXXX, XXXXXXX
),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [5] = { ENCODER_CCW_CW(RM_HUED, RM_HUEU),           ENCODER_CCW_CW(RM_SATD, RM_SATU) },
    [6] = { ENCODER_CCW_CW(RM_HUED, RM_HUEU),           ENCODER_CCW_CW(RM_SATD, RM_SATU) },
    [7] = { ENCODER_CCW_CW(RM_HUED, RM_HUEU),           ENCODER_CCW_CW(RM_SATD, RM_SATU) },
    [8] = { ENCODER_CCW_CW(RM_VALD, RM_VALU),           ENCODER_CCW_CW(RM_NEXT, RM_PREV)}
};
#endif
