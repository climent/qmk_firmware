...
//     KC_TAB  , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   ,                KC_Y   , KC_U   , KC_I   , KC_O   , KC_P    ,KC_BSLS ,
     ...
     NAV,         LWR ,KC_LALT , KC_LGUI,KC_ENT , KC_LBRC ,                KC_RBRC, KC_SPC , RSE    , NAV    , KC_LGUI   ,KC_RCTL 
...
[_RAISE] = LAYOUT(\
  ...
  _______, _______, KC_HOME, _______, KC_END , _______,                    KC_PGUP, XXXXXXX, KC_UP  , KC_LBRC, KC_RBRC, KC_DEL , \
...
[_ADJUST] = LAYOUT(\
  ...
  XXXXXXX, XXXXXXX, RM_VALD, RM_TOGG, RM_VALU, XXXXXXX,                    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  XXXXXXX, XXXXXXX, RM_NEXT, XXXXXXX, RM_PREV, XXXXXXX,                    XXXXXXX, C(S(KC_TAB)), XXXXXXX, C(KC_TAB), XXXXXXX, XXXXXXX, \
  XXXXXXX, XXXXXXX, RM_HUEU, XXXXXXX, RM_HUED, XXXXXXX,                    XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX, \
  _______,          _______, _______, _______, KC_SPC , KC_HOME, KC_END  , _______, _______, KC_RGUI, KC_RALT, _______\
),
...
[_NAV] = LAYOUT(
  ...
  XXXXXXX   ,          MS_BTN1, MS_BTN2, KC_LGUI, KC_SPC, XXXXXXX, XXXXXXX,G(KC_SPC),XXXXXXX, KC_ENT, XXXXXXX, XXXXXXX
),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [6] = { ENCODER_CCW_CW(RM_VALD, RM_VALU) }
};
#endif
